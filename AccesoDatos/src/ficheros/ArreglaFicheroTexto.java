...
escribiendo en un BufferedWriter, utilizando ficheros temporales, y renombrando ficheros.
...
El renombrado de ficheros consiste no solo en un cambio de nombre, sino también de ubicación,
si se especifica un directorio distinto a aquel en que está ubicado el fichero.
Es recomendable, y se puede ver que es muy sencillo, hacer que los programas realicen copias de seguridad de todos aquellos ficheros que vayan a modificar,
